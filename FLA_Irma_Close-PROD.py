...
wb1 = load_workbook(r'C:\Users\garren-james\Python Projects\FLORIDA Irma Closure PT\IRMA-Pending-Cases-County-PROD.xlsx')
...
while x <= int(y): #specify number of times to run process
    ...
    if (em.string_found(24, 2, "MUST") == True):
        ...
        col2= 'B'+str(rn)
        ws1[col2] = "Done"
        wb1.save('IRMA-Pending-Cases-County-PROD.xlsx')
        rn += 1
        print(rn)
        x += 1
